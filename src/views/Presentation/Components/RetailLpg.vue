...
<template>
  <div class="container mt-sm-5">
    <div
      ...
      :style="{
        backgroundImage:
          'url(https://images.unsplash.com/photo-1631985455894-65311148a768?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80)'
      }"
      loading="lazy"
    >
